...
import cityboys.golfInfo.Clubs;
import cityboys.golfInfo.Courses;
import cityboys.rastimar.RastimaYfirlit;
import cityboys.rastimar.StartingTimes;
...
public class DatabaseConnection extends AsyncTask<Void, Void, Boolean> {
    ...
    public DatabaseConnection(String arg1, String arg2, String arg3, String link, char type) {
        mArg1 = arg1;
        mArg2 = arg2;
        mArg3 = arg3;
        mLink = link;
